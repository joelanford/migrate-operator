...
import (
	...
	originalv1 "github.com/joelanford/migrate-operator/pkg/apis/original/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &originalv1.App{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
...
func newPodForCR(cr *originalv1.App) *corev1.Pod {
